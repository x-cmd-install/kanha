...
[![x-cmd/install — kanha Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/kanha.svg?lang=zh)](https://x-cmd.com/install/kanha)
...
合计: **1,051** 行代码（覆盖前 5 种语言、共 **23** 个文件）。
...
- **上游仓库**: <https://github.com/pwnwriter/kanha>
- **官网**: <https://crates.io/crates/kanha>
- **许可证**: MIT
...
- **Star**: 325 · **Fork**: 18 · **开放 issue**: 8 · **贡献者**: 3

## 累计统计

- **发布数**: 3 · **已合并 PR**: 16 · **开放 PR**: 6 · **已关闭 issue**: 7 · **开放 issue**: 1 · **提交数**: 136
...
| last720d | 2024-10-06 | 0 | 0 | 6 | 0 | 0 | 3 |
...
kanha 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `kanha` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/kanha.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T02:48:48Z._
